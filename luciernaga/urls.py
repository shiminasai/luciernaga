...
urlpatterns = [
    ...
    path('publicaciones/', TemplateView.as_view(template_name="publicaciones.html")),
    path('detalle-publicacion/', TemplateView.as_view(template_name="detalle_publicacion.html")),
